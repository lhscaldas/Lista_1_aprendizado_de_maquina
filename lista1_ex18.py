...
#item a
Hx=-(px[0]*np.log2(px[0])+px[1]*np.log2(px[1]))
print(f"item a) H[x]={Hx:.4f}")

#item b
Hy=-(py[0]*np.log2(py[0])+py[1]*np.log2(py[1]))
print(f"item b) H[y]={Hy:.4f}")

#item c
Hy_x=-(
       pxy[0][0]*np.log2(py_x0[0])+
       pxy[0][1]*np.log2(py_x0[1])+
       #pxy[1][0]*np.log2(py_x1[0])+
       pxy[1][1]*np.log2(py_x1[1])
       )
print(f"item c) H[y|x]={Hy_x:.4f}")

#item d
Hx_y=-(
       pxy[0][0]*np.log2(px_y0[0])+
       #pxy[1][0]*np.log2(px_y0[1])+
       pxy[0][1]*np.log2(px_y1[0])+
       pxy[1][1]*np.log2(px_y1[1])
       )
