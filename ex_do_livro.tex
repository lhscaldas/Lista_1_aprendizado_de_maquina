...
\begin{tabular}{l}
    ...
    \\
    $y e^{-\frac{y^2}{2 \sigma^2}} \quad \text{é impar, então a integral de} \quad(-\infty, \infty) \quad \text {é nula}$ \\
    \\
...
\begin{tabular}{l}
    ...
    $ \displaystyle  \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad  \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad  \quad \quad \quad \quad \quad - \int \int \mathbb{E}[z] x p(x)p(z) dx dz$\\
...
\begin{tabular}{l}
    ...
    \\
    Como os integrandos são iguais e as regiões são complementares, podemos unir as \\
    duas integrais para todo o domínio\\
    \\
